<template>
  ...
  <div class="d-flex justify-content-between">
    <!-- Clicker à gauche -->
    <div class="match-clicker">
      <h2>Match Clicker</h2>
      <p>Cliquez pour gagner des points !</p>
      <button @click="matchCookie" class="btn btn-success">
        <img src="@/assets/match.png" alt="Match" class="match-image" />
      </button>
      <p>Nombre de Match : {{ clicks }}</p>
    </div>
  ...
  calculatePassiveClicks() {
    ...
    buyBuilding(building) {
      if (this.clicks >= building.cost) {
        ...
        alert('Pas assez de matchs pour acheter ce bâtiment !');
      }
    },
    async saveData() {
      try {
